/*	MessageBoxEx - Centers a MessageBox relative to its parent form
	Taken from: https://stackoverflow.com/questions/1732443/center-messagebox-in-parent-form#3498791
	Known Issues: Does not work with multiple monitors when parent window is moved from the main display.
*/
		...
		private static void Initialize()
		{
			if (_hookProc == null)
			{
				...
				if (_owner != null)
				{
					...
					uint iThreadId = GetWindowThreadProcessId(ptr, out uint processID);
